...
scp -i ${aws_pem_location} ${ec2_username}@${ec2_hostname}:/usr/src/larsethia/server/backups/${latest_db} ../server/evennia-pulled.db3

# For your safety, not overwriting automatically
# mv ../server/evennia-pulled.db3 ../server/evennia.db3
