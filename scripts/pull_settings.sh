...
scp -i ${aws_pem_location} ${ec2_username}@${ec2_hostname}:/usr/src/larsethia/server/conf/settings.py ../server/conf/settings-pulled.py

# For your safety, not overwriting automatically
# mv ../server/conf/settings-pulled.py ../server/conf/settings.py
